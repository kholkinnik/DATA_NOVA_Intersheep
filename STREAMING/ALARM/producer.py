# импорт библиотеки для работы с продюсером kafka
...
producer.flush()  # гарантирует (синхронно дожидается), что все буферизированные данные отправятся в Kafka
print("✅ Данные отправлены в Kafka в топик ")